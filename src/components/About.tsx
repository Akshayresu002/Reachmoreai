    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 mb-20 items-end">
          ...
          >
            We are an elite squad of system engineers and conversational designers. We believe AI callers, chat agents, and operations pipelines should be indistinguishable from a hyper-trained, elite operations workforce.
          </motion.div>
        </div>

        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-10 mb-16">
          ...
          <div className="col-span-2">
            ...
            <p className="text-xs font-light text-neutral-500 max-w-[240px] leading-relaxed mb-6">
              ReachMore AI is a premier AI Automation Agency engineering advanced AI Workflows, custom AI Chatbots, and automated Lead Generation Systems to accelerate scaling for modern businesses.
            </p>
            {/* Social icons */}
